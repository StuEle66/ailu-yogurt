...
function readArtifacts(repoRoot) {
  ...
  if (manifest.id !== CANONICAL_PLUGIN_ID || manifest.version !== '0.5.0') {
    throw new Error('Release manifest is not the canonical Ailu 0.5.0 identity.');
  }
